...
package com.minhky.testworker.viewmodel
    ...
    companion object {
        ...
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                val observerFruittesUseCase = appContainer.observerFruittesUseCase
                MainViewModel(observerFruittesUseCase = observerFruittesUseCase)
            }
        }
